...
for model_name, model in models.items():
    ...
    plt.savefig(f"/home/alvaro/Documents/Workspace/midi/models/mean_var_rgb_training/results/7_models_{model_name}_cm.png")
    plt.close()

    # Save model
    with open(f"/home/alvaro/Documents/Workspace/midi/models/mean_var_rgb_training/models/7_models_{model_name}_pipeline.pkl", "wb") as f:
